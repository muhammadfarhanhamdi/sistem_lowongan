...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Edit Kategori Lowongan</h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                <form action="{{ route('admin.kategori_lowongan.update', $kategori->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="text" class="form-control w-50" id="nama_kategori" name="nama_kategori"
                            placeholder="Masukan Nama Kategori" value="{{ old('nama_kategori', $kategori->nama_kategori) }}">
                    </div>
