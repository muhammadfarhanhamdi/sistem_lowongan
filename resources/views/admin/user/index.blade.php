...
<div class="d-sm-flex align-items-center justify-content-between mb-4 ">
    <div>
        ...
        <h4 class="main-title mb-0">Daftar User</h4>
    </div>
    <div>
        <a href="{{ route('admin.user.add') }}" class="btn btn-success">
            <i class="ri-pencil-line"></i> Tambah User
        </a>
    </div>
</div>
            ...
            <table id="datatable" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="p-1 text-center" style="width: 20%;">Nama</th>
                        <th scope="col" class="p-1 text-center" style="width: 20%;">Email</th>
                        <th scope="col" class="p-1 text-center" style="width: 15%;">Username</th>
                        <th scope="col" class="p-1 text-center" style="width: 15%;">Role</th>
