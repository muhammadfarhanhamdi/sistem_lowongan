...
<div class="d-sm-flex align-items-center justify-content-between mb-4 ">
    ...
    <div>
        <a href="{{ route('admin.jurusan.add') }}" class="btn btn-success">
            <i class="ri-pencil-line"></i> Tambah Jurusan
        </a>
    </div>
</div>
            ...
            <table id="datatable" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="p-1 text-center" style="width: 70%;">Nama Jurusan</th>
                    ...
                    @foreach ($jurusans as $jurusan)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.jurusan.edit', $jurusan->id) }}" class="btn btn-primary">
