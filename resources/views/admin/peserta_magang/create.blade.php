...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Tambah Data Peserta Magang</h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                <form action="{{ route('admin.peserta_magang.store') }}" method="POST">
                    @csrf
                    @method('POST')
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select required class="form-select" id="id_user" name="id_user">
                                    <option value="" disabled selected>-- Pilih User (Role: Peserta Magang) --</option>
                    ...
                    <input type="submit" value="Simpan Data Peserta" class="btn btn-primary">
                </form>
            </div>
        </div>
    </div>
