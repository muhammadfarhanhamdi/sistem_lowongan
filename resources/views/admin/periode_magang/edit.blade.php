...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="main-title mb-0">Edit Periode Magang</h4>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-3">
                <form action="{{ route('admin.periode_magang.update', $periode->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="text" class="form-control" id="nama_periode" name="nama_periode"
                            placeholder="Cth: Periode Magang Ganjil 2026" value="{{ old('nama_periode', $periode->nama_periode) }}">
                    </div>
